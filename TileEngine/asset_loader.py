...
class AssetLoader():
    ...
    def load_image(self, img_path, is_alpha = True):
    ...
    def load_spritesheet(self, img_path, num_rows, num_cols, is_alpha = True):
        images = []
        ...
        for curr_row in range(num_rows):
            ...
            for curr_col in range(num_cols):
                ...
                if is_alpha:
                    ...
                    surf = pygame.Surface((img_width, img_height)).convert()
                surf.blit(sheet, (0, 0),
